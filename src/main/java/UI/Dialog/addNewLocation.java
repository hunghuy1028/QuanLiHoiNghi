 ...
 * @author hungh
 */
public class addNewLocation extends javax.swing.JDialog {

    /**
     * Creates new form addNewLocation
     */
    public addNewLocation(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(kq)
        {
            ...
            addConferenceDialog.addCombobox();
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                addNewLocation dialog = new addNewLocation(new javax.swing.JFrame(), true);
